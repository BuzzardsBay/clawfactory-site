...
down and stayed down for about seven weeks (2026-05-22 .. 2026-07-10). Hosting
the public site in its own public repo means privatizing the product source can
never take the website down again.

## Contents

- `index.html` -- the landing page (v1.1.0 content). Self-contained: inline
  CSS/JS, data-URI favicon; fonts from Google Fonts.
- `CNAME` -- custom domain (clawfactory.app).

## DNS

Apex A records point at the GitHub Pages IPs; `www` CNAME points at
buzzardsbay.github.io. DNS is account-level and unchanged.
